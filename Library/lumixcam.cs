...
namespace LumixWrapper {
    ...
    ;
        ...
        public enum Lmx_TagID_Rec_Ctrl_Release : ulong {
            ...
            // Bulb (continuous) shutter sequence used by the extended (Tether) DLL: SS=BULB, then START (open
            // shutter), hold, STOP (close), FINALIZE. The public SDK exposes only ONESHOT.

...
namespace Roberthasson.NINA.Lumixcamera.LumixcameraTestCategory {
    ...
    public class LumixcameraCondition : SequenceCondition {
        /// <summary>
        ...
        public override object Clone() {
            return new LumixcameraCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(LumixcameraCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}